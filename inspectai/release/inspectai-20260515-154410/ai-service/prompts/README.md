...
当前只有 3 个模板接成熟 prompt：`zihan_energy`、`zihan_daily`、`hot_water_room`。其他已恢复展示的模板（UPS / 变电所 / 消防泵 / 生活水泵 / 扶梯 / 电梯 ×2）走兜底策略：
...
- `[2026-05-15 codex]` 恢复会议中心模板入口；能耗抄表恢复消防水表字段，未接 prompt 的会议中心模板保持人工填写兜底
