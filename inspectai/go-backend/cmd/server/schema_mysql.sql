...
CREATE TABLE IF NOT EXISTS records (
    ...
    engineering_task_id VARCHAR(64)  NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS engineering_plan_items (
    ...
    sequence_no    VARCHAR(32)  NOT NULL DEFAULT '',
    ...
    scope_desc     MEDIUMTEXT   NOT NULL,
    budget_amount  DOUBLE       NOT NULL DEFAULT 0,
    budget_text    VARCHAR(64)  NOT NULL DEFAULT '',
    plan_start     VARCHAR(40)  NOT NULL DEFAULT '',
    plan_end       VARCHAR(40)  NOT NULL DEFAULT '',
    owner_name     VARCHAR(64)  NOT NULL DEFAULT '',
    cycle_text     VARCHAR(128) NOT NULL DEFAULT '',
    remark         MEDIUMTEXT   NOT NULL,
    status         VARCHAR(32)  NOT NULL DEFAULT '',
    risk_level     VARCHAR(32)  NOT NULL DEFAULT '',
    latest_task_id VARCHAR(64)  NOT NULL DEFAULT '',
    created_at     VARCHAR(40)  NOT NULL,
    updated_at     VARCHAR(40)  NOT NULL,
    INDEX idx_eng_plans_project (project, category),
    INDEX idx_eng_plans_status (status, plan_end),
    INDEX idx_eng_plans_owner (owner_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS engineering_tasks (
    id              VARCHAR(64)  NOT NULL PRIMARY KEY,
    plan_item_id    VARCHAR(64)  NOT NULL DEFAULT '',
    source          VARCHAR(64)  NOT NULL DEFAULT '',
    ...
    status          VARCHAR(32)  NOT NULL DEFAULT '',
    evidence_status VARCHAR(32)  NOT NULL DEFAULT '',
    ...
    budget_amount   DOUBLE       NOT NULL DEFAULT 0,
    close_result    VARCHAR(64)  NOT NULL DEFAULT '',
    close_note      MEDIUMTEXT   NOT NULL,
    created_at      VARCHAR(40)  NOT NULL,
    updated_at      VARCHAR(40)  NOT NULL,
    INDEX idx_eng_tasks_plan (plan_item_id),
    INDEX idx_eng_tasks_status (status, due_at),
    INDEX idx_eng_tasks_project (project, category),
    INDEX idx_eng_tasks_assignee (assignee_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
